...
(function () {
    ...
    angular.module('com.vyom.vyomlib.view-components.bar')
        .factory('comVyomVyomlibBarDesign',
            function (comVyomVyomlibBarModel, rxGUID, RX_DEFINITION_PICKER) {
                ...
                return {
                    ...
                    getModel: function (componentDefinition, componentDescriptor) {
                        return new comVyomVyomlibBarModel(getRxConfig(componentDefinition, componentDescriptor));
                    }
                };
            });
})();